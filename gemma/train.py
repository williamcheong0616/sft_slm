...
Arch:   Gemma 3 (decoder, 4B params, 128K context)
Base:   google/gemma-3-4b-it

Usage:
  python gemma/train.py --no-wandb
  python gemma/train.py --epochs 5 --lr 1e-4 --batch-size 1
"""
...
def load_model_and_tokenizer():
    """Load Gemma-SEA-LION in 4-bit with its processor."""
...
def train(args):
    ...
    print(f"\n🚀 Training Gemma-SEA-LION-v4-4B-VL")
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune Gemma-SEA-LION-v4-4B-VL")
